...
Caso de mensajes de error.

![](CAPTURA/pc.png)

Formulario en una pc.

![](CAPTURA/movil.png)

Formulario en un movil.
...
## Autor
- Nombre completo  JAIRO AMIR CAHUN TAMAY
- N° Control 221K0036
- Grupo 8 B
- Sitio  - [Agrega tu nombre aquí](https://formulariojairocahun.gamer.gd/?i=1)
- Github - [amircahun23-hash](https://github.com/amircahun23-hash/FORMULARIOJAIROCAHUN)
